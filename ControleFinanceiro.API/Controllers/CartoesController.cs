...
namespace ControleFinanceiro.API.Controllers
{
    ...
    {
        public readonly ICartaoRepositorio _cartaoRepositorio;
        public readonly IDespesaRepositorio _despesaRepositorio;
        ...
        public async Task<ActionResult> PutCartao(int id, Cartao cartao)
        {
            if (id != cartao.CartaoId)
                return BadRequest("Cartões diferentes, não foi possível atualziar");
